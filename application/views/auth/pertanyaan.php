...
<head>
    ...
    <title>E Voting | Pertanyaan Konfirmasi Keamanan</title>
</head>
<body>
                ...
                <div class="card">
                    <div class="card-body">                  
                        ...
                        <?php echo form_open('auth/verify_security_question'); ?>
                            ...
                            <div class="mb-3">
                                <label for="jawaban" class="form-label">Sesuaikan dengan jawaban anda saat login :</label>
                                <input type="text" name="jawaban" class="form-control" id="jawaban" value="<?php echo set_value('jawaban'); ?>">
                            </div>
                            <div class="mb-3">
